...
\end{equation}
After rotating the original image as described it will be translated so that 
the eyes appear in the intended location.
...
\begin{equation}
    ...
    \end{bmatrix}
\end{equation}
where $\alpha = s\cos\theta$ and $\beta = s\sin\theta$.
