...
mouth, jaw and the overall shape of the face.
...
\unsure[inline]{Should I put here step-by-step snapshots of face transformation? For example: original, rotated, scaled, translated.}
\unsure[inline]{Alternatively, I could do the same with a graph and vectors representing the eyes.}
