...
\label{impl:fd}
\improvements[inline,caption={}]{Open source C++ implementation by eHarmony
modified to interact with other components. One Node.js and a few Bash scripts
to manage face detection jobs.}
